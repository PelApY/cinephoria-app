...
<?php
// Inclure le contrôleur des cinémas
require_once __DIR__ . '/../src/controllers/CinemaController.php';
            ...
            <section id="cinemaInfos">
                <div class="container text-md-start">
                    <div class="row mx-auto">
                        ...
                        <?php foreach ($cinemas as $cinema): ?>
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-0 mt-4">
                            <h6 class="text-uppercase fw-bold mb-2"><?= htmlspecialchars($cinema['cinema_nom']) ?></h6>
                            <ul class="list-unstyled d-flex flex-column">
                                <li><i class="fas fa-home me-3"></i><?= htmlspecialchars($cinema['cinema_adresse']) ?></li>
                                <li><i class="fas fa-envelope me-3"></i><a href="mailto:<?= htmlspecialchars($cinema['cinema_email']) ?>"><?= htmlspecialchars($cinema['cinema_email']) ?></a></li>
                                <li><i class="fas fa-phone me-3"></i><?= htmlspecialchars($cinema['cinema_numero']) ?></li>
                                <li><i class="fas fa-clock me-3"></i>Horaires : <?= htmlspecialchars($cinema['cinema_horaires']) ?></li>
                            </ul>
                        </div>
                        <?php endforeach; ?>
                    </div>
